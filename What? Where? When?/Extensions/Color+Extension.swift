...
extension UIColor {
    ...
    public static let backgroundDarkGold = UIColor(red: 145 / 255.0, green: 104 / 255.0, blue: 58 / 255.0, alpha: 1.0)
    ...
    public static let accentDarkGray = UIColor(red: 151 / 255.0, green: 151 / 255.0, blue: 151 / 255.0, alpha: 1.0)
}
